...
/** Column headers (Russian, matching the app's UI language). */
 ...
 * Every money value passes through `@utils/money`; the base amount uses each
 * transaction's frozen `rateToBaseE6` (rule 2), so the export matches history.
 */
