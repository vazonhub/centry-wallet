...
export const en = {
  ...
  accessibility: {
    title: 'Accessibility',
    subtitle:
      'Centry follows your iOS accessibility settings. Change them in Settings → Accessibility; the app updates instantly.',
    on: 'On',
    off: 'Off',
    voiceOver: 'VoiceOver',
    voiceOverDesc: 'Screens, amounts and buttons are labelled for the screen reader.',
    largerText: 'Larger Text',
    largerTextDesc: 'Text scales with Dynamic Type (numbers stay aligned).',
    boldText: 'Bold Text',
    boldTextDesc: 'Heavier font weights across the app.',
    reduceMotion: 'Reduce Motion',
    reduceMotionDesc: 'Collapses and skeletons stop animating.',
    increaseContrast: 'Increase Contrast',
    increaseContrastDesc: 'Switches to a high-contrast palette with solid surfaces.',
    differentiateWithoutColor: 'Differentiate Without Color',
    differentiateWithoutColorDesc:
      'Meaning is never carried by colour alone (signs and labels too).',
    openSettings: 'Open iOS accessibility settings',
    footnote: 'These are read from your system settings — Centry never overrides them.',
  },
  money: {
    title: 'Money',
  ...
  goals: {
    ...
    newGoal: 'New goal',
    editTitle: 'Edit goal',
    empty: 'No goals yet. Create one and move money onto it — it stays out of your daily spending.',
    of: 'of',
    name: 'NAME',
    ...
    color: 'COLOUR',
    topUp: 'Add money',
    topUpTitle: 'Add to “{{name}}”',
    topUpFrom: 'FROM ACCOUNT',
    amount: 'AMOUNT',
    edit: 'Edit',
    close: 'Close',
    closeTitle: 'Close this goal?',
    closeBody:
      'Closing “{{name}}” means you bought it — the saved money is spent and the goal is archived. This isn’t counted as a daily expense.',
    closeConfirm: 'Close goal',
    hint: 'Money is moved onto a goal by a transfer, so it never counts as spending. Goal money is still part of your total.',
  },
  data: {
    title: 'Data',
    ...
    share: 'Share',
    exportHint:
      'Exports every record to a CSV file (opens in Excel or Google Sheets) and shows the share menu.',
    importCsv: 'Import from CSV',
    choose: 'Choose',
    importHint:
      'Reads a CSV exported from Centry back in. Expense/income rows are added and missing accounts are created; transfers are skipped (they can’t be reconstructed from CSV).',
    importEmptyTitle: 'Nothing imported',
    importEmptyBody: 'No expense or income rows were found in that file.',
    importDoneTitle: 'Import complete',
    importDoneBody: 'Added {{imported}} records ({{skipped}} skipped, {{accounts}} new accounts).',
    importFailedTitle: 'Import failed',
    importFailedBody: 'That file couldn’t be read. Make sure it’s a CSV exported from Centry.',
    dataSection: 'DATA',
  ...
  onboarding: {
    langThemeTitle: 'Language & appearance',
    langThemeLead:
      'Pick the language and theme you’re most comfortable with. You can change both anytime in Settings.',
    continue: 'Continue',
    back: 'Back',
